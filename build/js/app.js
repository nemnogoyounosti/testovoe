...
/***/ "./src/app/js/custom-ui/burger.js":
/*!****************************************!*\
  !*** ./src/app/js/custom-ui/burger.js ***!
  \****************************************/
...
class Burger {
  constructor(selector) {
    ...
    this._init = true;
    this._burger = Object(mobx__WEBPACK_IMPORTED_MODULE_0__["observable"])({
      isOpen: 'no',
  ...
  init() {
    var beforeAction = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    var afterAction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    ...
    if (this._el !== null) {
      ...
      console.log('Не удалось обнаружить данный элемент:', this._elSelector);
    }
  }
...
/***/ "./src/app/js/custom-ui/float-container.js":
/*!*************************************************!*\
  !*** ./src/app/js/custom-ui/float-container.js ***!
  \*************************************************/
/*! exports provided: FloatContainer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FloatContainer", function() { return FloatContainer; });
/* harmony import */ var mobx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mobx */ "./node_modules/mobx/lib/mobx.module.js");
...
class FloatContainer {
  constructor(containerSelector, closeSelector) {
    ...
    this._init = false;
    this._floatContainer = Object(mobx__WEBPACK_IMPORTED_MODULE_0__["observable"])({
      isOpen: 'no',
    ...
    Object(mobx__WEBPACK_IMPORTED_MODULE_0__["autorun"])(() => {
      var state = this._floatContainer.isOpen;
      ...
      if (!this._init) {
        ...
        if (this._openEl !== null) {
          ...
          console.log('Не удалось обнаружить данный элемент:', this._closeSelector);
        }
      }
    });
  }
...
/* harmony import */ var _test__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./test */ "./src/app/js/test.js");
/* harmony import */ var _custom_ui_burger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./custom-ui/burger */ "./src/app/js/custom-ui/burger.js");
/* harmony import */ var _custom_ui_float_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./custom-ui/float-container */ "./src/app/js/custom-ui/float-container.js");




jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(() => {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('[modal-id]').each((_, v) => {
    var btn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(v);
    var modalSelector = btn.attr('modal-id');
    var closeSelector = btn.attr('close-btn-id');
    btn.click(() => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(modalSelector).attr('show', 'yes');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("".concat(modalSelector, " ").concat(closeSelector)).click(() => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(modalSelector).attr('show', 'no');
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(modalSelector).click(function (e) {
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).is(modalSelector)) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(modalSelector).attr('show', 'no');
      }
    });
  });
...
/***/ 0:
/*!**************************************************!*\
  !*** multi @babel/polyfill ./src/app/js/main.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./src/app/js/main.js */"./src/app/js/main.js");
